...
pub enum AtomicRMWBinOp {
    ...
    /// Increments the value in memory, wrapping back to zero when incremented above the input value.
    #[llvm_versions(19.1..)]
    #[llvm_variant(LLVMAtomicRMWBinOpUIncWrap)]
    UIncWrap,

    /// Decrements the value in memory, wrapping back to the input value when decremented below zero.
    #[llvm_versions(19.1..)]
